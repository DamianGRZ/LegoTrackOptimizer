...
```
 ...
 src/sampling.py                                    |    7 +-
 44 files changed, 3384 insertions(+), 19 deletions(-)
```
...
- Generations: 300
- Population: 1000
- Feasible solutions: 71/1000
- **Best feasible**: 121 pieces, util=59.1%, speed=1.00 m/s, switches=1
- **Best overall (infeasible)**: 141 pieces, util=69.7%, speed=0.99 m/s, switches=2, CV=0.18
