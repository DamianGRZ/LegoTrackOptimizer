# Run Info — 2026-06-07T18:42:38

## Code State

- **Commit**: `e93d88f docs(spec): record the CV-schedule-independence pivot (weighted scale, not per-constraint eps)`
- **Branch**: `main`
...
- Generations: 300
- Population: 1000
- Feasible solutions: 54/1000
- **Best feasible**: 120 pieces, util=58.1%, speed=1.00 m/s, switches=1
- **Best overall (feasible)**: 120 pieces, util=58.1%, speed=1.00 m/s, switches=1, CV=0.00
