...
```
 ...
 12 files changed, 507 insertions(+), 41 deletions(-)
```
...
- **Best feasible**: 104 pieces, util=49.5%, speed=0.89 m/s, switches=0
- **Best overall (feasible)**: 104 pieces, util=49.5%, speed=0.89 m/s, switches=0, CV=0.00
