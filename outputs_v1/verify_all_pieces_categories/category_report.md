...
- bbox: 448 x 96 studs in 500 x 500 box
- context: a passing siding adds a parallel track segment inside the loop's existing bounding box

## cross
- utilization: 16.7% (44.8pp below global best)
- pieces: 34, speed: 0.89 m/s, cross count: 1
- bbox: 160 x 160 studs in 500 x 500 box
